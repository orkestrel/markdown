...
| `delimiterToAlignments`     | function | `(delimiter: string) => readonly TableAlign[]`                                                       | Derives per-column alignment from a GFM delimiter row.                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `projectHTMLLeaf`     | function | `(leaf: CommentNode \| DoctypeNode \| TextNode) => MarkdownProjection`                               | Projects one HTML leaf: text with its whitespace runs collapsed (its raw value kept for code), a comment and a doctype to nothing.                                                                                                                                                                                                                                                                                                             |
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Emphasis           | Even emphasis nesting depths use `*em*` / `**strong**`; odd depths use `_em_` / `__strong__`, preventing nested delimiter collisions.                                                                              |
